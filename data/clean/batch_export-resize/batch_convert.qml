...
MuseScore {
    menuPath: "Plugins." + qsTr("Batch Convert Resize Height") // this doesn't work, why?
    version: "3.5"
    requiresScore: false
    ...
    Timer {
        ...
        onTriggered: {
            ...
            // read file
            //resultText.append("YOOOO")
            //resultText.append(fileFullPath)
            var thisScore = readScore(fileFullPath, true)

            //resultText.append("YOOOO2222")
            ...
            if (thisScore) {
                ...
                // Custom stuff
                thisScore.style.setValue("pageHeight", 1.2);
                thisScore.style.setValue("titleFramePadding", 0);
                thisScore.style.setValue("pageOddTopMargin", 0);
                thisScore.style.setValue("pageEvenTopMargin", 0);
                ...
                // Remove the .mscz (comment this out later?)
